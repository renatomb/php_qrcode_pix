...
$px[01]="11"; //Se o valor 12 estiver presente, significa que o BR Code só pode ser utilizado uma vez. 
$px[26][00]="br.gov.bcb.pix"; //Indica arranjo específico; “00” (GUI) obrigatório e valor fixo: br.gov.bcb.pix
$px[26][01]="416caefa-cca4-4745-8ea7-31186a9b3d04"; //Chave do destinatário do pix, pode ser EVP, e-mail, CPF ou CNPJ.
$px[26][02]="Fulano"; // Descrição da transação, opcional.
$px[26][03]="00416968"; // Descrição da transação, opcional.
/*
...
$px[54]="247.00"; //Valor da transação, se comentado o cliente especifica o valor da transação no próprio app. Utilizar o . como separador decimal. Máximo: 13 caracteres.
$px[58]="BR"; //“BR” – Código de país ISO3166-1 alpha 2
$px[59]="RMB INFORMATICA"; //Nome do beneficiário/recebedor. Máximo: 25 caracteres.
